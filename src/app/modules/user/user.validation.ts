...
export const createDoctorZodSchema = z.object({
    ...
    doctor: z.object({
        ...
        currentWorkingPlace: z.string("Current working place is required").min(5, "Current working place must be at least 5 characters long").max(50, "Current working place must be less than 50 characters").optional(),
    }),
